...
echo -e "\033[1;35m"
git clone https://github.com/Brashkie/BrashkieBotMild-H.git
...
echo -e "\033[01;32m\033[01mIniciando BrashkieBotMild-H!!\nStarting BrashkieBotMild-H!!\n\033[0m"
npm start
