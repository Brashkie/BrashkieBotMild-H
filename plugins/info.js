...
git clone https://github.com/Brashkie/BrashkieBotMild-H 
cd GataBotLite-MD
yarn install
npm install
npm start`
...
let replit = `*◎ R E P L I T*\n\nhttps://github.com/Brashkie/BrashkieBotMild-H`
...
description = official[0][0] == String(contact[0]) ? 'Solo temas de HepeinBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'socialplus.electronicatodo2006@gmail.com' : official[1][0] == String(contact[0]) ? 'electronicatodo2006@gmail.com' : official[2][0] == String(contact[0]) ? 'moisesplaygame917@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/Brashkie' : official[1][0] == String(contact[0]) ? 'https://github.com/Brashkie' : official[2][0] == String(contact[0]) ? 'https://github.com/Brashkie' : official[3][0] == String(contact[0]) ? 'https://github.com/Brashkie' : md    
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.youtube.com/channel/UCKwgQ_LQgAlSmVrYHiHH_1Q' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'elanimadormoises123@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
